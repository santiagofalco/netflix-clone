      ...
      ">
                ...
                <div className="
                    ...
                    <div className="flex flex-row items-center gap-3">
                        <div className="cursor-pointer w-6 h-6 lg:w-10 lg:h-10 bg-white text-neutral-700 rounded-full flex justify-center items-center transition hover:bg-neutral-400"
